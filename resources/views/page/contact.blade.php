...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="/">DU Online Voting System</a>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('{{asset('img/du-banner.jpg')}}')">
    ...
    <script src="{{asset('news/js/clean-blog.min.js')}}"></script>
